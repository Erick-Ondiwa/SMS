...
namespace schoolManagement.API.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Grades_Enrollments_EnrollmentStudentId_EnrollmentCourseId",
                        columns: x => new { x.EnrollmentStudentId, x.EnrollmentCourseId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_EnrollmentStudentId_EnrollmentCourseId",
                table: "Grades",
                columns: new[] { "EnrollmentStudentId", "EnrollmentCourseId" });
